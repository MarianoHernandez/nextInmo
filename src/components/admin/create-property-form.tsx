...
import { PropertyStatus, PropertyTypes } from "@/types/property"
...
export default function CreatePropertyForm() {
  ...
  const goToNextStep = () => {
    const steps = ["basic", "details", "location", "images", "review"]
        ...
        <Card className="pb-4">
          <CardContent className="pt-6">
            ...
            <Tabs value={activeTab} onValueChange={handleTabChange} className="w-full">
              ...
              <TabsContent value="basic" className="space-y-6">
                <div className="grid gap-6 md:grid-cols-2">
                  <FormField
                    ...
                    name="title"
                    rules={{ required: "El título es obligatorio", minLength: { value: 5, message: "El título debe tener al menos 5 caracteres" } }}
                    render={({ field }) => (
                      <FormItem>
                  ...
                  <FormField
                    control={form.control}
                    name="price"
                    rules={{ required: "El precio es obligatorio", min: { value: 1, message: "El precio debe ser mayor a 0" } }}
                    render={({ field }) => (
                      <FormItem>
                ...
                <FormField
                  ...
                  rules={{ required: "La descripción corta es obligatoria", minLength: { value: 10, message: "La descripción corta debe tener al menos 10 caracteres" } }}
                  render={({ field }) => (
                    <FormItem>
                ...
                <FormField
                  ...
                  rules={{ required: "La descripción completa es obligatoria", minLength: { value: 50, message: "La descripción completa debe tener al menos 50 caracteres" } }}
                  render={({ field }) => (
                    <FormItem>
              ...
              <TabsContent value="details" className="space-y-6">
                <div className="grid gap-6 md:grid-cols-2">
                  <FormField
                    control={form.control}
                    name="lotSize"
                    rules={{ required: "El tamaño del terreno es obligatorio", min: { value: 1, message: "El tamaño debe ser mayor a 0" } }}
                    render={({ field }) => (
                      <FormItem>
              ...
              <TabsContent value="location" className="space-y-6">
                <div className="grid gap-6 md:grid-cols-2">
                  <FormField
                    control={form.control}
                    name="address"
                    rules={{ required: "La dirección es obligatoria", minLength: { value: 5, message: "La dirección debe tener al menos 5 caracteres" } }}
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>Dirección</FormLabel>
                        <FormControl>
                          <Input placeholder="Ej: Av. Brasil 2846" {...field} />
                        </FormControl>
                  ...
                  <FormField
                    control={form.control}
                    name="neighborhood"
                    rules={{ required: "El barrio es obligatorio", minLength: { value: 2, message: "El barrio debe tener al menos 2 caracteres" } }}
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>Barrio</FormLabel>
                        <FormControl>
                          <Input placeholder="Ej: Pocitos" {...field} />
                        </FormControl>
                ...
                <FormField
                  control={form.control}
                  name="geoCoordinates"
                  rules={{ required: "La ubicación en el mapa es obligatoria" }}
                  render={({ field }) => (
                    <FormItem>
              ...
              <TabsContent value="images" className="space-y-6">
                <FormField
                  control={form.control}
                  name="imageSrc"
                  rules={{ required: "Debe subir al menos una imagen", validate: (value) => value.length > 0 || "Debe subir al menos una imagen" }}
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>Imágenes de la Propiedad</FormLabel>
                      <FormControl>
                        <ImageUploader value={field.value} onChange={(urls) => field.onChange(urls)} maxFiles={10} />
                      </FormControl>
                      <FormDescription>
            ...
            <div className="mt-6 flex justify-between">
              <Button  className="bg-nav hover:bg-accent text-white" type="button" variant="outline" onClick={goToPreviousStep} disabled={activeTab === "basic"}>
