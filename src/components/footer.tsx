...
import { Facebook, Instagram, Twitter, Linkedin, Youtube, Mail, MapPin, Phone, ArrowRight } from "lucide-react"
      ...
      <div className="container mx-auto px-4 pt-8 pb-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-primary-foreground/80 mb-6">
              Tu socio inmobiliario en la costa de Rocha. Ofrecemos las mejores propiedades en venta.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-primary-foreground/80">Yaneo esq Zapican, La Paloma, Rocha, Uruguay</span>
              </li>
              <li className="flex items-center">
                <Phone className="mr-2 h-5 w-5 text-primary-foreground/80" />
                <span className="text-primary-foreground/80">+598 98 384 860</span>
              </li>
              <li className="flex items-center">
          ...
          <div>
            ...
            <p className="text-primary-foreground/80 mb-4">
              Suscríbete para recibir las últimas propiedades y noticias inmobiliarias
            </p>
            <div className="flex">
              <input
                type="email"
        ...
        <div className="mt-12 border-t border-primary-foreground/20 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-primary-foreground/70 mb-4 md:mb-0">
            © {new Date().getFullYear()} Inmobiliaria Costa Azul. Todos los derechos reservados.
          </p>
          <div className="flex space-x-4 text-sm">
            <Link href="/terminos" className="text-primary-foreground/70 hover:text-white transition-colors">
              Términos y Condiciones
            </Link>
            <Link href="/privacidad" className="text-primary-foreground/70 hover:text-white transition-colors">
...
function FooterLink({ href, children }: { href: string; children: React.ReactNode }) {
  return (
    <li>
      <Link href={href} className="text-primary-foreground/80 hover:text-white transition-colors">
        {children}
      </Link>
    </li>
  )
